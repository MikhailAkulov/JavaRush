...
Пустых полей у объекта User быть не может.
Дату в файле удобно хранить в формате long.
...
//            File fileName = File.createTempFile("your_file_name", null);
            File fileName = new File ("C:\\Users\\Akulo\\Desktop\\SourceDirectory\\testFile2002.txt");
            OutputStream outputStream = new FileOutputStream(fileName);
            InputStream inputStream = new FileInputStream(fileName);

            JavaRush javaRush = new JavaRush();
            //initialize users field for the javaRush object here - инициализируйте поле users для объекта javaRush тут
            javaRush.users.clear();       //  чтобы проверить когда список пустой
