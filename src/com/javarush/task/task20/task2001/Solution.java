...
В этой задаче нужно сохранить в файл состояние работы программы и вычитать состояние из файла
...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File fileName = new File("C:\\Users\\Akulo\\Desktop\\SourceDirectory\\testFile2001.txt");
